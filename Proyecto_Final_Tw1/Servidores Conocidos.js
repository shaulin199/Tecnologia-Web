...
// ID Ciudad: Departamento de Cochabamba:  3919966
// URL: api.openweathermap.org/data/2.5/weather?id=3919966&units=metric&appid=e19d105c22c1f38a43162f6011a1ceac

const requestURL="https://api.openweathermap.org/data/2.5/weather?id=3919966&units=metric&appid=e19d105c22c1f38a43162f6011a1ceac";
...
function mostrarClima(Clima_json)
{
    ...
    //section
     ...
     Div6.appendChild(tema);
     Div6.appendChild(max);
     Div6.appendChild(min);
}